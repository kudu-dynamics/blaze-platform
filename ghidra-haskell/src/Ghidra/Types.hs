...
type AddressArray = J ('Java.Array ('Java.Class "ghidra.program.model.address.Address"))
...
type Data = J ('Java.Class "ghidra.program.model.listing.Data")
type DataIterator = J ('Java.Class "ghidra.program.model.listing.DataIterator")
...
type FunctionManagerDB = J ('Java.Class "ghidra.program.database.function.FunctionManagerDB")
...
type MemoryMapDB = J ('Java.Class "ghidra.program.database.mem.MemoryMapDB")
type MemoryBlock = J ('Java.Class "ghidra.program.model.mem.MemoryBlock")
type MemoryBlockDB = J ('Java.Class "ghidra.program.database.mem.MemoryBlockDB")
...
type ReferenceArray = J ('Java.Array ('Java.Class "ghidra.program.model.symbol.Reference"))
...
type Set a = J ('Java.Class "java.util.Set")
