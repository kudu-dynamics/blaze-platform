...
$(mkPointer "BNSection" "BNFreeSection")
$(mkPointer "BNSaveSettings" "BNFreeSaveSettings")
$(mkPointer "BNTypeLibrary" "BNFreeTypeLibrary")
-- $(mkPointer "BNQualifiedNameAndType" "BNFreeQualifiedNameAndType")