...
-- demo :: [LStmt]
-- demo = [ LAnn "+" $ TFunc [TAnyInt, TAnyInt] TAnyInt
--        , LAnn "==" $ TFunc [TAnyInt, TAnyInt] TBool
-- --       , LDef "x" $ LInt 35
-- --       , LDef "x" $ LBool True
--        , LDef "y" $ (LApply "+" [LVar "x", LInt16 4])
...
--   LInt16 _ -> return [(TVar xvar, TInt16)]
--   LInt32 _ -> return [(TVar xvar, TInt32)]
