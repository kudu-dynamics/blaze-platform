...
--  )
-- import Blaze.Import.Source.BinaryNinja.Pil (createCallSite)
-- import Blaze.Import.Source.BinaryNinja.Types (CallInstruction, toCallInstruction)
...
--           && (Cg.DestFunc callee == acn ^. #callSite . #callDest) =
--         Just acn
--       | otherwise = Nothing
--     f _ = Nothing
