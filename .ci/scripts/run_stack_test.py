...
and determine the correct exit code based on that. Then promptly killall stack and blaze-test,
...
as any process matching `stack` or `blaze-test` will be killed, not necessarily just
...
def cleanup_and_exit(retcode):
    ...
    print('killall blaze-test')
    subprocess.run(['killall', 'blaze-test'])
    print('done!')
